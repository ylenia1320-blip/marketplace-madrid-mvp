...
// Navy  #000000  — authority, contracts, structure
// Gold  #B8860B  — premium / private-parties tier
// Teal  #000000  — active state, confirmed match
...
const seedProfiles = [
  { id: "p1", name: "Carla M.", age: 24, city: "Madrid", rate: 25, bio: "3 años de experiencia en atención al público en ferias y stands.", photo: null },
  { id: "p2", name: "Elena R.", age: 27, city: "Madrid", rate: 30, bio: "Azafata de eventos corporativos, inglés C1.", photo: null },
];

const seedEvents = [
  {
    id: "e1", clientName: "TechExpo Ibérica", type: "feria",
    venue: "Stand B14 - Pabellón 6", date: "2026-07-18", time: "10:00 - 18:00",
    city: "Madrid", location: "IFEMA, Madrid", budget: 60, spots: 2,
    functions: "Recepción de visitantes y apoyo comercial en stand.",
...
const TYPE_LABEL = { corporativo: "Evento corporativo", private: "Private party", vip: "VIP / Privado", feria: "Feria / Stand" };
// Minimalismo: casi todo en tinta; el dorado apagado se reserva solo para las categorías premium.
const TYPE_COLOR = {
  corporativo: { text: "#000000", border: "#D8D3C7" },
  private: { text: "#B8860B", border: "#B8860B" },
  vip: { text: "#B8860B", border: "#B8860B" },
  feria: { text: "#000000", border: "#D8D3C7" },
};
...
function Avatar({ name, photo, size = 40 }) {
  ...
  return (
    <div
      ...
      style={{ width: size, height: size, backgroundColor: "#000000", color: "#F5E6C8", fontSize: size * 0.38 }}
    >
      {initials}
    </div>
  );
...
function EventTicket({ event, profiles, children, revealed = true }) {
  ...
  return (
    <div className="rounded-lg border" style={{ borderColor: "#E5E0D3" }}>
      <div className="p-6" style={{ backgroundColor: "#FFFFFF" }}>
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h3 className="font-display text-xl mt-2" style={{ color: "#000000" }}>
          ...
          <div className="text-right font-body">
            <div className="flex items-center gap-1 justify-end text-sm font-semibold" style={{ color: "#000000" }}>
      ...
      <div className="p-6 pt-5" style={{ backgroundColor: "#FFFFFF" }}>{children}</div>
    </div>
  );
}
...
function StepFlow({ active }) {
  const steps = [
    { n: 1, label: "Publicar evento" },
    { n: 2, label: "Profesionales aplican" },
    { n: 3, label: "Selección / match" },
    { n: 4, label: "Contrato generado" },
  ];
  return (
        ...
        <React.Fragment key={s.n}>
          <div className="flex flex-col items-center gap-2 text-center w-20">
            <div
              ...
              style={{ backgroundColor: active >= s.n ? "#B8860B" : "#D8D3C7" }}
            />
            <span className="text-[10px] leading-tight tracking-wide uppercase" style={{ color: active >= s.n ? "#000000" : "#B0A88E" }}>{s.label}</span>
          </div>
          {i < steps.length - 1 && (
            <div className="flex-1 h-px mb-5" style={{ backgroundColor: active > s.n ? "#B8860B" : "#E5E0D3" }} />
          )}
        </React.Fragment>
      ))}
    </div>
      ...
      <div className="bg-white rounded-lg max-w-lg w-full max-h-[85vh] overflow-y-auto shadow-2xl">
        <div className="p-5 flex items-center justify-between border-b" style={{ borderColor: "#E5E0D3" }}>
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display text-lg" style={{ color: "#000000" }}>Anexo I + Contrato de trabajo generado</h3>
          </div>
        ...
        <div className="p-6 font-body text-sm text-stone-700 leading-relaxed space-y-4">
          ...
          <p className="font-semibold" style={{ color: "#000000" }}>REUNIDOS</p>
          ...
          <p className="font-semibold" style={{ color: "#000000" }}>EXPONEN</p>
        ...
        <div className="p-5 border-t flex flex-col gap-2" style={{ borderColor: "#E5E0D3" }}>
          ...
          <div className="flex justify-end gap-2 flex-wrap">
            <button
              ...
              style={{ color: "#000000", border: "1px solid #E5E0D3" }}
            >
              Cerrar
            </button>
            {event.confidential && (
...
export default function App() {
  ...
  const [eventForm, setEventForm] = useState({
    clientName: "", type: "feria", venue: "", date: "", timeStart: "", timeEnd: "",
  ...
  function handlePostEvent(e) {
    ...
    setEvents(next);
    setEventForm({ clientName: "", type: "feria", venue: "", date: "", timeStart: "", timeEnd: "", city: "Madrid", location: "", budget: "", clientPrice: "", spots: "1", functions: "", confidential: false, billingEntity: "" });
      ...
      <div className="min-h-screen font-body" style={{ backgroundColor: "#FBF9F4" }}>
        ...
        <div className="max-w-2xl mx-auto px-6 pt-28 pb-24">
          <div className="flex flex-col items-center mb-16">
            <span className="font-display text-base tracking-[0.35em] uppercase" style={{ color: "#000000" }}>
              Selecta
            </span>
            <div className="w-10 h-px mt-4" style={{ backgroundColor: "#B8860B" }} />
          </div>

          <h1 className="font-display text-center text-5xl md:text-6xl leading-[1.08] tracking-tight" style={{ color: "#000000" }}>
            Tú eliges quién<br />representa tu marca.
          </h1>
          <p className="font-body text-center text-stone-500 mt-7 max-w-sm mx-auto text-[15px] leading-relaxed">
            Ves fotos, idiomas y tarifa reales antes de decidir — no una asignación a ciegas. Ferias, stands y eventos corporativos.
          </p>

          <div className="flex items-center justify-center flex-wrap gap-x-3 gap-y-1 mt-12 font-body text-[11px] tracking-[0.1em] uppercase text-stone-400">
            <span>Publicar</span><span style={{ color: "#D8D3C7" }}>—</span>
            <span>Aplicar</span><span style={{ color: "#D8D3C7" }}>—</span>
            <span>Elegir</span><span style={{ color: "#D8D3C7" }}>—</span>
            <span>Contrato</span>
          </div>

          <div className="grid sm:grid-cols-2 mt-20 border-t" style={{ borderColor: "#E5E0D3" }}>
            <button
              onClick={() => setRole("cliente")}
              className="group text-left py-10 sm:pr-10 sm:border-r border-b sm:border-b-0"
              style={{ borderColor: "#E5E0D3" }}
            >
              <span className="font-body text-[11px] tracking-[0.15em] uppercase text-stone-400">Para empresas</span>
              <h3 className="font-display text-3xl mt-3" style={{ color: "#000000" }}>Soy Cliente</h3>
              <p className="font-body text-sm text-stone-500 mt-3 leading-relaxed max-w-xs">Feria, stand o evento corporativo. Publica tu necesidad y elige tú misma a las candidatas.</p>
              <div className="mt-6 flex items-center gap-1.5 text-sm font-semibold" style={{ color: "#000000" }}>
            ...
            <button
              ...
              className="group text-left py-10 sm:pl-10 pt-8 sm:pt-10"
            >
              <span className="font-body text-[11px] tracking-[0.15em] uppercase text-stone-400">Para profesionales</span>
              <h3 className="font-display text-3xl mt-3" style={{ color: "#000000" }}>Soy Profesional</h3>
              <p className="font-body text-sm text-stone-500 mt-3 leading-relaxed max-w-xs">Modelo de imagen o azafata. Regístrate y aplica a eventos disponibles.</p>
              <div className="mt-6 flex items-center gap-1.5 text-sm font-semibold" style={{ color: "#000000" }}>
                Entrar <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
              </div>
            </button>
          ...
          <div className="text-center mt-16">
            <button
              ...
              className="font-body text-xs text-stone-400 hover:text-stone-600"
            >
    ...
    if (!adminUnlocked) {
      return (
        <div className="min-h-screen font-body flex items-center justify-center" style={{ backgroundColor: "#FBF9F4" }}>
          {FONTS}
          <div className="bg-white rounded-lg p-8 border max-w-sm w-full mx-6" style={{ borderColor: "#E5E0D3" }}>
            <div className="flex items-center gap-2 mb-1">
              <Lock size={16} style={{ color: "#B8860B" }} />
              <h2 className="font-display text-xl" style={{ color: "#000000" }}>Panel Administrador</h2>
            </div>
            ...
            >
              ...
              <button type="submit" className="w-full font-body text-sm font-semibold px-5 py-2.5 rounded-full text-white" style={{ backgroundColor: "#000000" }}>
                Entrar
              </button>
      ...
      <div className="min-h-screen font-body" style={{ backgroundColor: "#FBF9F4" }}>
        ...
        <div className="border-b bg-white" style={{ borderColor: "#E5E0D3" }}>
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <span className="font-body text-sm font-semibold" style={{ color: "#000000" }}>Panel Administrador</span>
          </div>
        </div>

        <div className="max-w-4xl mx-auto px-6 py-12 space-y-10">
          <div className="grid sm:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg p-5 border" style={{ borderColor: "#E5E0D3" }}>
              <p className="font-body text-xs text-stone-400 uppercase tracking-wide">Ingresos totales</p>
              <p className="font-display text-2xl mt-1" style={{ color: "#000000" }}>{totalRevenue.toFixed(0)} €</p>
            </div>
            <div className="bg-white rounded-lg p-5 border" style={{ borderColor: "#E5E0D3" }}>
              <p className="font-body text-xs text-stone-400 uppercase tracking-wide">Pagado a Profesionales</p>
              <p className="font-display text-2xl mt-1" style={{ color: "#000000" }}>{totalCost.toFixed(0)} €</p>
            </div>
            <div className="bg-white rounded-lg p-5 border" style={{ borderColor: "#B8860B" }}>
              <p className="font-body text-xs uppercase tracking-wide" style={{ color: "#B8860B" }}>Tu margen (eventos)</p>
              <p className="font-display text-2xl mt-1" style={{ color: "#000000" }}>{totalMargin.toFixed(0)} €</p>
            </div>
            <div className="bg-white rounded-lg p-5 border" style={{ borderColor: "#000000" }}>
              <p className="font-body text-xs uppercase tracking-wide" style={{ color: "#000000" }}>Ingresos por suscripción</p>
              <p className="font-display text-2xl mt-1" style={{ color: "#000000" }}>{subsRevenue.toFixed(0)} €/mes</p>
              <p className="font-body text-[11px] text-stone-400">{subscribedCount} local(es) suscrito(s)</p>
            </div>
          </div>

          <section>
            <h2 className="font-display text-xl mb-4" style={{ color: "#000000" }}>Ganancias por local</h2>
            {venueRows.length === 0 ? (
              <p className="font-body text-sm text-stone-400">Todavía no hay eventos con match confirmado.</p>
            ) : (
              <div className="bg-white rounded-lg border overflow-hidden" style={{ borderColor: "#E5E0D3" }}>
                <table className="w-full font-body text-sm">
                  <thead>
                    <tr style={{ backgroundColor: "#F2EFE6" }}>
                      <th className="text-left px-4 py-3 font-semibold" style={{ color: "#000000" }}>Local</th>
                      <th className="text-right px-4 py-3 font-semibold" style={{ color: "#000000" }}>Eventos</th>
                      <th className="text-right px-4 py-3 font-semibold" style={{ color: "#000000" }}>Ingresos</th>
                      <th className="text-right px-4 py-3 font-semibold" style={{ color: "#000000" }}>Margen</th>
                      <th className="text-center px-4 py-3 font-semibold" style={{ color: "#000000" }}>Suscrito</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      return (
                        <tr key={venue} className="border-t" style={{ borderColor: "#E5E0D3" }}>
                          <td className="px-4 py-3">
                            <span className="font-semibold" style={{ color: "#000000" }}>{venue}</span>
                          ...
                          <td className="px-4 py-3 text-right font-semibold" style={{ color: "#000000" }}>{(data.revenue - data.cost).toFixed(0)} €</td>
                          <td className="px-4 py-3">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                onClick={() => toggleClientSub(venue)}
                                className="text-xs font-semibold px-3 py-1 rounded-full text-white"
                                style={{ backgroundColor: sub.subscribed ? "#000000" : "#B0A896" }}
                              >
          ...
          <section>
            <h2 className="font-display text-xl mb-4" style={{ color: "#000000" }}>Resumen anual</h2>
              ...
              {yearOptions.map((yr) => {
                ...
                return (
                  <div key={yr} className="bg-white rounded-xl p-4 border flex items-center justify-between" style={{ borderColor: "#E5E0D3" }}>
                    <span className="font-body font-semibold" style={{ color: "#000000" }}>{yr}</span>
                    ...
                    <span className="font-body text-sm font-semibold" style={{ color: "#000000" }}>{(yrRevenue - yrCost).toFixed(0)} € margen</span>
                  </div>
                );
              })}
            </div>
    ...
    return (
      <div className="min-h-screen font-body" style={{ backgroundColor: "#FBF9F4" }}>
        ...
        <div className="max-w-3xl mx-auto px-6 py-12 space-y-10">
          ...
          <section className="bg-white rounded-lg p-6 border" style={{ borderColor: "#E5E0D3" }}>
            <h2 className="font-display text-xl mb-4" style={{ color: "#000000" }}>Publicar evento</h2>
            <form onSubmit={handlePostEvent} className="grid sm:grid-cols-2 gap-3">
              ...
              <Select label="Tipo" value={eventForm.type}
                ...
                options={[["feria", "Feria / Stand"], ["corporativo", "Evento corporativo"], ["private", "Private party (premium)"], ["vip", "VIP / Privado (a medida)"]]} />
              ...
              <div>
                ...
                {(() => {
                  ...
                  return (
                    <p className="font-body text-[11px] mt-1" style={{ color: belowMinimum ? "#C0392B" : "#000000" }}>
                      {belowMinimum
              ...
              <div>
                ...
                {eventForm.budget && eventForm.clientPrice && Number(eventForm.clientPrice) > Number(eventForm.budget) && (
                  <p className="font-body text-[11px] mt-1" style={{ color: "#000000" }}>
              ...
              {eventForm.type === "vip" && (
                <div className="sm:col-span-2 rounded-xl p-4 space-y-3" style={{ backgroundColor: "#F2EFE6" }}>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="font-body text-xs font-semibold" style={{ color: "#000000" }}>Evento confidencial</p>
                  </div>
              ...
              <div className="sm:col-span-2 flex justify-end">
                <button type="submit" className="flex items-center gap-2 font-body text-sm font-semibold px-5 py-2.5 rounded-full text-white" style={{ backgroundColor: "#000000" }}>
          ...
          <section>
            <h2 className="font-display text-xl mb-4" style={{ color: "#000000" }}>Mis eventos</h2>
            <div className="space-y-5">
              {events.filter(e => e.clientName).map((ev) => (
                <EventTicket key={ev.id} event={ev}>
                  {ev.selected ? (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm font-body font-semibold" style={{ color: "#000000" }}>
                      ...
                      <button
                        ...
                        className="text-xs font-semibold underline" style={{ color: "#000000" }}
                      >
                        Ver contrato
                      </button>
                    </div>
    ...
    return (
      <div className="min-h-screen font-body" style={{ backgroundColor: "#FBF9F4" }}>
        ...
        <div className="max-w-md mx-auto px-6 py-10">
          <h2 className="font-display text-2xl mb-1" style={{ color: "#000000" }}>Crear perfil</h2>
          <p className="font-body text-sm text-stone-500 mb-6">Verificación de identidad simulada en este prototipo.</p>
          <form onSubmit={handleRegister} className="bg-white rounded-lg p-6 border space-y-3" style={{ borderColor: "#E5E0D3" }}>
            <div>
            ...
            <button type="submit" className="w-full font-body text-sm font-semibold px-5 py-2.5 rounded-full text-white mt-2" style={{ backgroundColor: "#000000" }}>
  ...
  return (
    <div className="min-h-screen font-body" style={{ backgroundColor: "#FBF9F4" }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-10">
        ...
        {myEvents.length > 0 && (
          <section>
            <h2 className="font-display text-xl mb-4" style={{ color: "#000000" }}>Confirmados</h2>
            <div className="space-y-5">
              {myEvents.map((ev) => (
                <EventTicket key={ev.id} event={ev}>
                  <div className="flex items-center justify-between">
        ...
        <section>
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            <h2 className="font-display text-xl" style={{ color: "#000000" }}>Eventos disponibles</h2>
            <div className="flex items-center gap-2">
              <MapPin size={14} className="text-stone-400" />
              <select
                value={cityFilter}
                ...
                style={{ border: "1px solid #E5E0D3", color: "#000000" }}
              >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            {role === "cliente" ? (
              ...
              <UserRound size={15} style={{ color: "#000000" }} />
            )}
            <span className="font-body text-sm font-semibold" style={{ color: "#000000" }}>
...
function Toast({ text }) {
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <div className="flex items-center gap-2 font-body text-sm text-white px-4 py-2.5 rounded-full shadow-lg" style={{ backgroundColor: "#000000" }}>
